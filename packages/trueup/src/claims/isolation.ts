...
const LOOSE = [
  "A file sits directly in the directory whose children are being kept apart, so it belongs to no sibling and the isolation rule does not govern it. It may reach into every group and nothing will say so.",
  "",
  "Do this:",
