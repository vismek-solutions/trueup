export const PLACEMENT = [
  ...
  "- `... and by this file as well` means another declaration here reads it, so the file it leaves would have to import it back. Move that declaration with it, or leave both where they are. This clause can ride along with the one above, and then both are true. The zone may be reading it through that neighbour, in which case moving the pair leaves the zone crossing the boundary for the neighbour instead.",
