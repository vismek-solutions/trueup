...
import type { BindingKind, Declaration, Mention, ProseInCode } from "../ports/module-record.ts";
...
export interface Project {
  ...
  readonly commentsIn: (file: string) => readonly Span[];
  readonly proseIn: (file: string) => ProseInCode;
